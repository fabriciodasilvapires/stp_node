...
// Rotas de endereço
routes.get(`${path}/endereco`, jwtMiddleware, checkRole(["ROLE_ADMIN", "ROLE_MEDICO", "ROLE_MEDICO_REGULADOR"]), enderecoController.getAll);
routes.post(`${path}/endereco`, jwtMiddleware, checkRole(["ROLE_ADMIN"]), enderecoController.create);
routes.get(`${path}/endereco/:id`, jwtMiddleware, checkRole(["ROLE_ADMIN", "ROLE_MEDICO", "ROLE_MEDICO_REGULADOR"]), enderecoController.getById);
routes.delete(`${path}/endereco/:id`, jwtMiddleware, checkRole(["ROLE_ADMIN"]), enderecoController.verifyIfExists, enderecoController.delete);
routes.put(`${path}/endereco/:id`, jwtMiddleware, checkRole(["ROLE_ADMIN"]), enderecoController.update);

// Rotas de especialidade
routes.get(`${path}/especialidade`, jwtMiddleware, checkRole(["ROLE_ADMIN", "ROLE_MEDICO", "ROLE_MEDICO_REGULADOR"]), especialidadeController.getAll);
routes.post(`${path}/especialidade`, jwtMiddleware, checkRole(["ROLE_ADMIN"]), especialidadeController.create);
routes.get(`${path}/especialidade/:id`, jwtMiddleware, checkRole(["ROLE_ADMIN", "ROLE_MEDICO", "ROLE_MEDICO_REGULADOR"]), especialidadeController.getById);
...
routes.get(`${path}/medicamento`, jwtMiddleware, checkRole(["ROLE_ADMIN", "ROLE_MEDICO", "ROLE_MEDICO_REGULADOR"]), medicamentoController.getAll);
routes.post(`${path}/medicamento`, jwtMiddleware, checkRole(["ROLE_ADMIN", "ROLE_MEDICO", "ROLE_MEDICO_REGULADOR"]), medicamentoController.create);
routes.get(`${path}/medicamento/:id`, jwtMiddleware, checkRole(["ROLE_ADMIN", "ROLE_MEDICO", "ROLE_MEDICO_REGULADOR"]), medicamentoController.getById);
routes.delete(`${path}/medicamento/:id`, jwtMiddleware, checkRole(["ROLE_ADMIN", "ROLE_MEDICO", "ROLE_MEDICO_REGULADOR"]), medicamentoController.verifyIfExists, medicamentoController.delete);
routes.put(`${path}/medicamento/:id`, jwtMiddleware, checkRole(["ROLE_ADMIN", "ROLE_MEDICO", "ROLE_MEDICO_REGULADOR"]), medicamentoController.update);

// Rotas de usuário
routes.get(`${path}/user`, jwtMiddleware, checkRole(["ROLE_ADMIN", "ROLE_MEDICO", "ROLE_MEDICO_REGULADOR"]), userController.getAll);
routes.post(`${path}/user`, jwtMiddleware, checkRole(["ROLE_ADMIN"]), userController.create);
routes.get(`${path}/user/:id`, jwtMiddleware, checkRole(["ROLE_ADMIN", "ROLE_MEDICO", "ROLE_MEDICO_REGULADOR"]), userController.getById);
...
routes.delete(`${path}/paciente/:id`, jwtMiddleware, checkRole(["ROLE_ADMIN"]), pacienteController.verifyIfExists, pacienteController.delete);
...
// Rotas de prontuário
routes.get(`${path}/prontuario`, jwtMiddleware, checkRole(["ROLE_ADMIN", "ROLE_MEDICO", "ROLE_MEDICO_REGULADOR"]), prontuarioController.getAll);
routes.post(`${path}/prontuario`, jwtMiddleware, checkRole(["ROLE_ADMIN", "ROLE_MEDICO", "ROLE_MEDICO_REGULADOR"]), prontuarioController.create);
routes.get(`${path}/prontuario/:id`, jwtMiddleware, checkRole(["ROLE_ADMIN", "ROLE_MEDICO", "ROLE_MEDICO_REGULADOR"]), prontuarioController.getById);
routes.delete(`${path}/prontuario/:id`, jwtMiddleware, checkRole(["ROLE_ADMIN", "ROLE_MEDICO", "ROLE_MEDICO_REGULADOR"]), prontuarioController.verifyIfExists, prontuarioController.delete);
routes.put(`${path}/prontuario/:id`, jwtMiddleware, checkRole(["ROLE_ADMIN", "ROLE_MEDICO", "ROLE_MEDICO_REGULADOR"]), prontuarioController.update);

// Rotas de unidade hospitalar
routes.get(`${path}/unidade`, jwtMiddleware, checkRole(["ROLE_ADMIN", "ROLE_MEDICO", "ROLE_MEDICO_REGULADOR"]), unidadeHospitalarController.getAll);
routes.post(`${path}/unidade`, jwtMiddleware, checkRole(["ROLE_ADMIN"]), unidadeHospitalarController.create);
routes.get(`${path}/unidade/:id`, jwtMiddleware, checkRole(["ROLE_ADMIN", "ROLE_MEDICO", "ROLE_MEDICO_REGULADOR"]), unidadeHospitalarController.getById);
...
routes.post(`${path}/transferencia`, jwtMiddleware, checkRole(["ROLE_MEDICO_REGULADOR"]), transferenciaController.create);
...
routes.delete(`${path}/transferencia/:id`, jwtMiddleware, checkRole(["ROLE_MEDICO_REGULADOR"]), transferenciaController.verifyIfExists, transferenciaController.delete);
routes.put(`${path}/transferencia/:id`, jwtMiddleware, checkRole(["ROLE_MEDICO_REGULADOR"]), transferenciaController.update);
